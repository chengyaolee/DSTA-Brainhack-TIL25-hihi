...
CUSTOM_REWARDS_DICT = {
    ...
    RewardNames.GUARD_CAPTURES: +30.0,
    RewardNames.GUARD_TRUNCATION: -15.0, # This corresponds to SCOUT_TRUNCATION for the Scout
...
if __name__ == '__main__':
    ...
    try:
        ...
        trained_scores = train_agent(
            ...
            scout_model="agent03_stacked_merged_50k_eps.pth", # "trained_dqn_agent.pth" to resume
            save_scout_model_to="agent03_stacked_merged_100k_eps.pth",
            guard_model="guard03_stacked_merged_50k_eps.pth", # "trained_dqn_agent.pth" to resume
