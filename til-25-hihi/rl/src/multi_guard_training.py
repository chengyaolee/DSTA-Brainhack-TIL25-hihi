...
EPSILON_START = 0.7
EPSILON_END = 0.01
EPSILON_DECAY = 0.9997 # Multiplicative decay factor per episode/fixed number of steps
...
def train_agent(env_module, num_episodes=2000, novice_track=False, load_scout_model_from=None, load_guard_model_from=None, save_model_to="trained_guard_dqn_agent.pth", render_mode=None, video_folder=None):
    ...
    scout_agent = TrainableRLAgent(model_load_path=load_scout_model_from, model_save_path=None) 
...
if __name__ == '__main__':
    ...
    try:
        ...
        trained_scores = train_agent(
            ...
            load_scout_model_from="agent03_new3_36k_eps.pth", # "trained_dqn_agent.pth" to resume
            load_guard_model_from="guard_141k_eps_multi.pth", # "trained_dqn_agent.pth" to resume
            save_model_to="guard_191k_eps_multi.pth",
            render_mode="rgb_array",
            video_folder="./rl_renders_guard_multi"
        )
