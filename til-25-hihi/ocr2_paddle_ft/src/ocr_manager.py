...
class OCRManager:
    def __init__(self):
        ...
        self.ocr_engine = PaddleOCR(
            ...
            # The following line has been removed to use the default dictionary
    ...
    def ocr(self, image_bytes: bytes) -> str:
        ...
        # The cls parameter is passed to the ocr method call, not the constructor.
        # It's generally recommended to keep it disabled if use_angle_cls is False.
